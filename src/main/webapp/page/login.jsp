...
<DIV id=logo><img src="${pageContext.request.contextPath}/images/logo.gif" alt="图片找不到"></DIV></DIV>
<DIV id=regLogin class=wrap>
<DIV class=dialog>
<DIV class=box>
<H4>用户登录</H4>
<FORM id=user method=post name=user action="${pageContext.request.contextPath}/page/proUserController/login.do">
<DIV class=infos>
<TABLE class=field>
  <TBODY>
  <TR>
