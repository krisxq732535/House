...
<META name=GENERATOR content="MSHTML 8.00.7601.17514">
  ...
  <script language="JavaScript">
     $(function(){  //jquery加载事件
         $("#but1").click(function () {
              //发送异步请求
             $.post("proUserController/check.do",{"name":$("#txtName").val()},function(data){
                 if(data.result==0){
...
<DIV class=box>
<FORM action="${pageContext.request.contextPath}/page/proUserController/reg.do"  method="post" name="form1">
<DIV class=infos>
<TABLE class=field>
  <TBODY>
  <TR>
